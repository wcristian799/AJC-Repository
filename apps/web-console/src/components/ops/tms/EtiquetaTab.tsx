  ...
  return (
    <div className="mt-5 space-y-4">
      <SectionHeader
        ...
        actions={
          <>
            <GhostButton icon={TagIcon}>Reimprimir lote</GhostButton>
      ...
      <div className="grid gap-6 lg:grid-cols-[auto_1fr]">
          ...
          <div className="w-[320px] overflow-hidden rounded-lg bg-white text-black shadow-[0_20px_50px_-20px_rgba(0,0,0,0.6)] ring-1 ring-black/10">
            ...
            <div className="flex items-stretch border-b-2 border-dashed border-black/30">
              ...
              <div className="grid place-items-center border-l-2 border-dashed border-black/30 px-3">
                ...
                <p className="text-[9px] uppercase text-black/40">Suite</p>
              </div>
            </div>
        ...
        <div className="space-y-4">
          <div className="surface-card p-5">
            <h3 className="font-display text-lg">Volume a etiquetar</h3>
            <p className="mt-1 text-xs text-muted-foreground">Selecione um volume para pré-visualizar a etiqueta. Cada bipe subsequente lê o QR/UUID impresso.</p>

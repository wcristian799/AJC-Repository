...
- **Rodada atual pós-validação do cliente (29/jun/2026):** core interno do front mockado já recebeu os ajustes da reunião/transcrição, mas o modelo real de prestação de contas recebido em 29/jun reabriu um refinamento pontual em `PrestacaoTab`. Fontes: `docs/feedback/2026-06-25-validacao-core-telas.md`, `docs/feedback/2026-06-29-modelo-prestacao-contas-gerentes-am-vi.md` e checklist operacional em `docs/fase-1/01-SPEC-Tarefas-Ajustes-Front-Pos-Validacao.md`. **Portal online continua MVP, mas fica por último.** Financeiro completo/Compras/DRE ficam para fase posterior conforme conversa.
...
- **Próxima frente ativa:** core interno do front refinado (Nova Viagem com campos Lucas + paradas automáticas do FAQ 2026, Nova Carga com pedido/UUID/QR/código/NF-DC, `PrestacaoTab` no modelo real, foto na portaria conferida). **Agora:** QA visual/navegação do core interno e só então atacar o Portal online. Atualizar checklist e `docs/STATUS.md` conforme avançar.
